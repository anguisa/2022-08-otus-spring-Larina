-- сначала все id текстовые (как заданы в mongo)

--changeset olga:2022-12-17-000-drop-all
...
--changeset olga:2022-12-17-001-author
create table author (
    id varchar(255),
    name varchar(255),
...
--changeset olga:2022-12-17-002-genre
create table genre (
    id varchar(255),
    title varchar(255),
...
--changeset olga:2022-12-17-003-book
create table book (
    id varchar(255),
    title varchar(255),
...
--changeset olga:2022-12-17-004-book-genre
...
--changeset olga:2022-12-17-005-book-comment
...
--changeset olga:2022-12-17-006-sequences
