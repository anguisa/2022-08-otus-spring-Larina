...
import ru.otus.service.ExecuteSqlScriptService;
...
public class JobConfig {
    ...
    public JobConfig(JobBuilderFactory jobBuilderFactory,
                     ...
                     ExecuteSqlScriptService executeSqlScriptService) {
        this.jobBuilderFactory = jobBuilderFactory;
        this.stepBuilderFactory = stepBuilderFactory;
        this.executeSqlScriptService = executeSqlScriptService;
    }

    @StepScope
    @Bean
    public Tasklet schemaInitTasklet(@Value("#{jobParameters['" + INIT_SCHEMA_FILE_NAME + "']}") String initSchemaFileName) {
    ...
    @StepScope
    @Bean
    public Tasklet schemaUpdateTasklet(@Value("#{jobParameters['" + UPDATE_SCHEMA_FILE_NAME + "']}") String updateSchemaFileName) {
        return (contribution, chunkContext) -> {
