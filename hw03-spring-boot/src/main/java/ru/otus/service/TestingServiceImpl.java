...
public class TestingServiceImpl implements TestingService {
    ...
    private Person obtainUser() {
        String firstName = ioService.readStringWithPrompt(localizationService.localizeMessage("testing.person.first_name"));
        String lastName = ioService.readStringWithPrompt(localizationService.localizeMessage("testing.person.last_name"));
