...
public class BookShellService {
    ...
    public String updateBook(@ShellOption(help = "Book id", value = {"--id", "--i"}) String bookId,
    ...
    public String getBookById(@ShellOption(help = "Book id", value = {"--id", "--i"}) String bookId) {
    ...
    public void deleteBookById(@ShellOption(help = "Book id", value = {"--id", "--i"}) String bookId) {
