...
class CommentDaoJpaTest {
    ...
    void shouldInsertComment() {
        ...
        Optional<Comment> actualComment = commentDao.findById(expectedComment.getId());
    ...
    void shouldUpdateComment() {
        ...
        Optional<Comment> commentBeforeUpdate = commentDao.findById(initialComment.getId());
        ...
        Optional<Comment> actualComment = commentDao.findById(updatedComment.getId());
    ...
    void shouldDeleteComment() {
        ...
        commentDao.deleteById(expectedComment.getId());
    ...
    void shouldReturnExpectedCommentById() {
        ...
        Optional<Comment> actualComment = commentDao.findById(expectedCommentId);
