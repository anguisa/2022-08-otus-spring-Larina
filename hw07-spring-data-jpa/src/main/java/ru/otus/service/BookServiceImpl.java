...
public class BookServiceImpl implements BookService {
    ...
    private Author getBookAuthor(Book book) {
        return authorDao.findByName(book.getAuthor().getName()).orElse(book.getAuthor());
    }
    ...
    private List<Genre> getBookGenres(Book book) {
        ...
        Map<String, Genre> genresFound = genreDao.findByTitleIn(genreTitles).stream().collect(Collectors.toMap(Genre::getTitle, Function.identity()));
