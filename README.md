...
|[hw18-spring-resilience4j](./hw18-spring-resilience4j)|**Цель:** Сделать внешние вызовы приложения устойчивыми к ошибкам.<br />**Описание:** Приложение с изолированными с помощью Hystrix / Resilience4j внешними вызовами.