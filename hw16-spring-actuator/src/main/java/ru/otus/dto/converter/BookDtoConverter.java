...
public class BookDtoConverter implements DtoConverter<Book, BookDto> {
    ...
    public BookDtoConverter(DtoConverter<Author, AuthorDto> authorConverter, DtoConverter<Genre, GenreDto> genreConverter) {
    ...
    public BookDto toDto(Book entity) {
        return new BookDto(
            ...
            (entity.getGenres() == null) ? null : entity.getGenres().stream().map(genreConverter::toDto).collect(Collectors.toList())
        );
    }
    ...
    public Book fromDto(BookDto dto) {
        return new Book(
            ...
            (dto.getGenres() == null) ? null : dto.getGenres().stream().map(genreConverter::fromDto).collect(Collectors.toList()),
            null
        );
    }
